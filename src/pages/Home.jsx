    ...
    <>
      ...
      <div className="value-bar">
        <div className="value-bar-inner">
          <div className="vi sr"><div className="vi-title">Operator-Led</div><div className="vi-desc">Every portfolio company is run by dedicated management, not by holding company staff.</div></div>
          <div className="vi sr sr-d1"><div className="vi-title">Cash-Flow Disciplined</div><div className="vi-desc">Capital allocation decisions are governed by operating cash flows, not valuation multiples.</div></div>
          <div className="vi sr sr-d2"><div className="vi-title">Structurally Risk-Contained</div><div className="vi-desc">Each entity is separately capitalized with ring-fenced liability at the SPV level.</div></div>
          <div className="vi sr sr-d3"><div className="vi-title">Institutionally Documented</div><div className="vi-desc">Governance, reporting, and compliance standards reflect institutional investor expectations.</div></div>
        </div>
      </div>
      ...
      <div className="sec-light">
        <div className="sec-inner">
          <div className="sr"><div className="sec-eye">About Us</div></div>
          <h2 className="sr sr-d1">A family office built around operating discipline</h2>
          <div className="prose sr sr-d2" style={{ maxWidth: 660 }}>
          ...
          <div className="sr sr-d3" style={{ marginTop: 32 }}>
      ...
      <div className="sec-dark">
        <div className="sec-inner">
          <div className="sr"><div className="sec-eye-w">Capital Structure</div></div>
          <h2 className="w sr sr-d1">How Value Moves Through the Portfolio</h2>
          <p className="lead w sr sr-d2">Capital flows from operating companies through Sarbok Group's shared services structure into DM Holdings for credit allocation and Sarbok Investments for direct deal vehicles.</p>
          <div className="cfdiag sr sr-d3">
      ...
      <div className="sec">
        <div className="sec-inner">
          <div className="sr"><div className="sec-eye">Portfolio</div></div>
          <h2 className="sr sr-d1">Our Portfolio</h2>
          <p className="lead sr sr-d2">A portfolio of operating companies, each independently managed and built for long-term institutional performance.</p>
          <div className="pgrid">
