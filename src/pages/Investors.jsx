    ...
    <>
      <div className="inner-hero">
        <div className="inner-hero-inner">
          ...
          <p>Sarbok Group engages with accredited investors, family offices, and institutional partners through a structured, documentation-first process.</p>
        </div>
      </div>

      <div className="sec"><div className="sec-inner">
        <StagingNotice><strong>Launch blocker:</strong> This page cannot go live without attorney-reviewed legal copy from Debra Buhring. Content shown is approved for staging. Investment Disclaimer below is a structural placeholder only.</StagingNotice>
        ...
        <div className="g2c">
          <div>
            ...
            <div className="ilist" style={{ marginTop: 22 }}>
      ...
      <div className="sec-light"><div className="sec-inner">
        <div className="sec-eye">Legal Disclaimer</div>
