    ...
    <>
      <div className="inner-hero">
        <div className="inner-hero-inner">
          ...
          <h1>Our Team</h1>
          <p>Operator-led management across the Sarbok Group portfolio. Each entity is run by dedicated leadership accountable to the Group's governance standards.</p>
        </div>
      </div>
      ...
      <div className="sec-light"><div className="sec-inner">
        <div className="sec-eye">Leadership Philosophy</div>
        <h2>Operator-Led at Every Level</h2>
