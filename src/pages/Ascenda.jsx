    ...
    <>
      <div className="inner-hero">
        <div className="inner-hero-inner">
          ...
          <h1>Ascenda Group</h1>
          <p>Healthcare services and retail brokerage platform — connecting brands to buyers across major retail channels.</p>
        </div>
      </div>
      ...
      <div className="sec"><div className="sec-inner">
        ...
        <div className="stats">
          ...
          <div className="stat"><div className="stat-val">Multi-Year</div><div className="stat-lbl">Client Retention Standard</div></div>
          <div className="stat"><div className="stat-val">MRR</div><div className="stat-lbl">Revenue Model</div></div>
        </div>
      </div></div>

      <div className="sec-light"><div className="sec-inner">
        <div className="sec-eye">Service Offerings</div>
        <h2>Engagement Tiers — Ascenda Sales</h2>
        <div className="tiers">
          <div className="tier"><div className="tier-n">Tier 1</div><div className="tier-name">Retail Broker</div><div className="tier-desc">Buyer introductions, category alignment, pitching, follow-up, roadshow and test-market opportunities, and expansion strategy.</div></div>
          <div className="tier"><div className="tier-n">Tier 2</div><div className="tier-name">Fractional CSO</div><div className="tier-desc">Retail strategy and channel planning, pricing and margin modeling, forecasting, performance management, and coordination across distributors, brokers, and retailers.</div></div>
          <div className="tier"><div className="tier-n">Tier 3</div><div className="tier-name">JV Partnership + CSO Support</div><div className="tier-desc">Strategic capital support, deep operational involvement, expansion roadmap, and a shared success model for long-term collaboration.</div></div>
        </div>
      ...
      <div className="sec"><div className="sec-inner">
        <div className="sec-eye">Vendor Intake</div>
        <h2>Apply to Work with Ascenda</h2>
        <p className="lead">Submit your information below. All inquiries are reviewed within three business days.</p>
